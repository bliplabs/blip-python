...
[**delete_biller**](BillersApi.md#delete_biller) | **DELETE** /v1/billers/{id} | Remove Biller
...
with blip.ApiClient() as api_client:
    ...
    try:
        # Remove Biller
        api_response = api_instance.delete_biller(id)
        pprint(api_response)
    except blip.ApiException as e:
        print("Exception when calling BillersApi->delete_biller: %s\n" % e)
```
