...
class BillerInResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, confidence, *args, **kwargs):  # noqa: E501
        """BillerInResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, confidence, *args, **kwargs):  # noqa: E501
        """BillerInResult - a model defined in OpenAPI
