...
class Biller(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, origin_id, *args, **kwargs):  # noqa: E501
        """Biller - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, origin_id, *args, **kwargs):  # noqa: E501
        """Biller - a model defined in OpenAPI
