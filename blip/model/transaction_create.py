...
class TransactionCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, amount, date, user_id, *args, **kwargs):  # noqa: E501
        """TransactionCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, amount, date, user_id, *args, **kwargs):  # noqa: E501
        """TransactionCreate - a model defined in OpenAPI
