...
class BillerCreateMultiResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, count, *args, **kwargs):  # noqa: E501
        """BillerCreateMultiResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ids ([int]): [optional] if omitted the server will use the default value of []  # noqa: E501
        """
