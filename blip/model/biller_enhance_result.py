...
def lazy_import():
    ...
    from blip.model.biller_in_enhance_result import BillerInEnhanceResult
    globals()['BillerEnhanceCreate'] = BillerEnhanceCreate
    globals()['BillerInEnhanceResult'] = BillerInEnhanceResult


class BillerEnhanceResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query': (BillerEnhanceCreate,),  # noqa: E501
            'billers': ([BillerInEnhanceResult],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query, billers, *args, **kwargs):  # noqa: E501
        """BillerEnhanceResult - a model defined in OpenAPI

        Args:
            query (BillerEnhanceCreate):
            billers ([BillerInEnhanceResult]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query, billers, *args, **kwargs):  # noqa: E501
        """BillerEnhanceResult - a model defined in OpenAPI
