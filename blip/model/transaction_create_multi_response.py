...
class TransactionCreateMultiResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, batch_id, count, *args, **kwargs):  # noqa: E501
        """TransactionCreateMultiResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, batch_id, count, *args, **kwargs):  # noqa: E501
        """TransactionCreateMultiResponse - a model defined in OpenAPI
