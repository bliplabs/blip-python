...
class BillerSearchParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'facets_distribution': ([str], none_type,),  # noqa: E501
            'attributes_to_retrieve': ([str],),  # noqa: E501
            'attributes_to_crop': ([str], none_type,),  # noqa: E501
            'crop_length': (int,),  # noqa: E501
            'attributes_to_highlight': ([str], none_type,),  # noqa: E501
            'matches': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'facets_distribution': 'facetsDistribution',  # noqa: E501
        'attributes_to_retrieve': 'attributesToRetrieve',  # noqa: E501
        'attributes_to_crop': 'attributesToCrop',  # noqa: E501
        'crop_length': 'cropLength',  # noqa: E501
        'attributes_to_highlight': 'attributesToHighlight',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BillerSearchParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            q (str): [optional] if omitted the server will use the default value of ""  # noqa: E501
            offset (int): [optional] if omitted the server will use the default value of 0  # noqa: E501
            limit (int): [optional] if omitted the server will use the default value of 20  # noqa: E501
            filter (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            facets_distribution ([str], none_type): [optional]  # noqa: E501
            attributes_to_retrieve ([str]): [optional] if omitted the server will use the default value of ["*"]  # noqa: E501
            attributes_to_crop ([str], none_type): [optional]  # noqa: E501
            crop_length (int): [optional] if omitted the server will use the default value of 200  # noqa: E501
            attributes_to_highlight ([str], none_type): [optional]  # noqa: E501
            matches (bool): [optional] if omitted the server will use the default value of False  # noqa: E501
