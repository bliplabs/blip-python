...
class BillerCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, origin_id, origin_name, *args, **kwargs):  # noqa: E501
        """BillerCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, origin_id, origin_name, *args, **kwargs):  # noqa: E501
        """BillerCreate - a model defined in OpenAPI
