...
class BillersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_biller_endpoint = _Endpoint(
            settings={
                'response_type': (Biller,),
                'auth': [],
                'endpoint_path': '/v1/billers/{id}',
                'operation_id': 'delete_biller',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_biller(
        ...
        **kwargs
        ...
        Remove a biller.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_biller(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.delete_biller_endpoint.call_with_http_info(**kwargs)
